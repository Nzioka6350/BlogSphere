   ...
   <CommonSection  title={title}></CommonSection>
      ...
      <div className='flex flex-col gap-y-2 '>
        ...
        <span className='flex gap-x-1'>{<> 
         <strike className='md:text-lg text-sm font-semibold text-orange-700 '>Ksh{<>{price + 1000}</>}</strike> <p className='md:text-lg text-sm font-semibold'>Ksh{price.toLocaleString()}</p> 
        </>}</span>
